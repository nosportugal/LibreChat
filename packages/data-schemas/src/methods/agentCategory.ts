...
export function createAgentCategoryMethods(mongoose: typeof import('mongoose')) {
  ...
  async function ensureDefaultCategories(): Promise<boolean> {
    ...
    const defaultCategories = [
      ...
      {
        value: 'content_communication',
        label: 'com_agents_category_content_communication',
        description: 'com_agents_category_content_communication_description',
        order: 1,
      },
      {
        value: 'information',
        label: 'com_agents_category_information',
        description: 'com_agents_category_information_description',
        order: 2,
      },
      {
        value: 'technical_operations',
        label: 'com_agents_category_technical_operations',
        description: 'com_agents_category_technical_operations_description',
        order: 3,
      },
      {
        value: 'people',
        label: 'com_agents_category_people',
        description: 'com_agents_category_people_description',
        order: 4,
      },
      {
        value: 'productivity',
        label: 'com_agents_category_productivity',
        description: 'com_agents_category_productivity_description',
        order: 5,
      },
      {
        value: 'it',
